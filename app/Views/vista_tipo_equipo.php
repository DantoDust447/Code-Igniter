...
<body>
                    ...
                    <form action="agregarTipoEquipo" method="post">
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input type="number" class="form-control" aria-label="Sizing example input" placeholder="id"
                                aria-describedby="inputGroup-sizing-sm" id="tipo_id" name="tipo_id" required>
                        </div>
                        <!--nombre-->
                        <div class="input-group input-group-sm mb-3">
    ...
    <div class="container"><table class="table">
        ...
        <tbody>
            <?php foreach ($datos as $tipoEquipo){
                ?>
            <tr>
                <td><?=$tipoEquipo['tipo_id'];?></td>
                <td><?=$tipoEquipo['nombre'];?></td>
                <td>
                    <a href="<?=base_url('editarTipoEquipo/'.$tipoEquipo['tipo_id'])?>" class="btn btn-warning btn-sm">Editar</a>
                    <a href="<?=base_url('eliminarTipoEquipo/'.$tipoEquipo['tipo_id'])?>" class="btn btn-danger btn-sm">Eliminar</a>
                </td>
            </tr>
            <?php
        }
